        ...
        while not done:
            ...
            if topic=="/luminar_front_points":
                ...
                if rounded_timestamp in frontdict.keys() and rounded_timestamp in leftdict.keys():
                    #combined = leftdict[rounded_timestamp] + frontdict[rounded_timestamp]
                    #combined = combined + pointCloud
                    #combined = leftdict[rounded_timestamp]
                    #combined.width += frontdict[rounded_timestamp].width
                    #combined.data += frontdict[rounded_timestamp].data
